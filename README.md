...
SingleStore is a real-time database designed to power modern, intelligent applications — delivering maximum performance for both transactional (OLTP) and analytical (OLAP) workloads in a single unified engine. SingleStore also features native [data integration services](https://www.singlestore.com/blog/introducing-native-data-integration-services/), including [connection links](https://docs.singlestore.com/db/v8.7/security/authentication/configuring-and-using-connection-links/). These links automatically detect table schemas and provision [pipelines](https://docs.singlestore.com/cloud/load-data/load-data-with-pipelines/pipeline-concepts/pipeline-overview/) supporting high-speed consistent data ingestion.
...
This github repository contains code to walk you through a migration from an Amazon MySQL RDS instance to a SingleStore cluster.
